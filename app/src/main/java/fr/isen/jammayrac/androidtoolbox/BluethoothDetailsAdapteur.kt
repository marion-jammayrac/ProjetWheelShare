...
import kotlinx.android.synthetic.main.bluetooth_char_cell.view.*
...
class BluetoothDetailsAdapter(
    ...
    override fun onCreateChildViewHolder(
        ...
        CharacteristicViewHolder(
            LayoutInflater.from(parent?.context)
                .inflate(R.layout.bluetooth_char_cell, parent, false)
        )
    ...
    override fun onBindChildViewHolder(
        ...
        holder.buttonWrite.setOnClickListener {
            ...
            val editView = View.inflate(context, R.layout.dialog_ble, null)
